...
with DAG(
    ...
    etl_dim_sites = BashOperator(
        ...
        bash_command="python /mnt/c/Users/User/Project/DataEngineer/increment-session/dim/dim_sites.py"
    )

    etl_dim_entities = BashOperator(
        task_id="etl_dim_entities",
        bash_command="python /mnt/c/Users/User/Project/DataEngineer/increment-session/dim/dim_entities.py"
    )

    etl_dim_groups = BashOperator(
        task_id="etl_dim_groups",
        bash_command="python /mutif-etl-folder/increment-session/dim/dim_groups.py"
    )

    etl_dim_currency = BashOperator(
        task_id="etl_dim_currency",
        bash_command="python /mutif-etl-folder/increment-session/dim/dim_currency.py"
    )

    etl_dim_pricelist = BashOperator(
        task_id=r"etl_dim_pricelist",
        bash_command=r"python /mutif-etl-folder/increment-session/dim/dim_pricelist_name.py"
    )

    etl_dim_customers = BashOperator(
        task_id="etl_dim_customers",
        bash_command="python /mutif-etl-folder/increment-session/dim/dim_customers.py"
    )
    ...
    etl_fact_sales_shipment = BashOperator(
        ...
        bash_command="python /mutif-etl-folder/increment-session/facts/fact_sales_shipment.py"
    )
