SELECT
    ...
    ar.ar_eff_date AS cashin_effective_date,
    ...
    ap.arpay_eff_date AS arpay_effective_date,
    (ap.arpay_eff_date - ar.ar_eff_date) AS day,
    ap.arpay_add_by as created_by,
    ap.arpay_add_date as created_at,
    ad.arpayd_exc_rate * ad.arpayd_amount AS cashin_detail_amount_idr
