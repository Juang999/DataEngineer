...
from mutif_etl.transform.dim.dim_groups import transform_data_groups
...
if __name__ == '__main__':
    ...
    extracted_data = extract_data_postgresql(connection=env_exapro, filename=file_dim_query, conditions=conditions)
