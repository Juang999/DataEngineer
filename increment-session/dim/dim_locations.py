...
if __name__ == '__main__':
    ...
    file_marker_query = Path(__file__).parent.parent.parent.joinpath(r"queries/inc/marker/dim/dim_locations.sql")
    file_dim_query = Path(__file__).parent.parent.parent.joinpath(r"queries/inc/dim/dim_locations.sql")
    ...
    transformed_data = transform_data_location(extracted_data_exapro)

    load_dataframe(connection=env_data_warehouse, schema="public", tablename="dim_locations", mode="append", df=extracted_data_exapro)
