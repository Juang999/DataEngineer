...
from mutif_etl.transform.dim.dim_pricelist import transform_data_pricelist
...
if __name__ == '__main__':
    ...
    file_marker_query = Path(__file__).parent.parent.parent.joinpath(r"queries/inc/marker/dim/dim_pricelist.sql")
    file_dim_query = Path(__file__).parent.parent.parent.joinpath(r"queries/inc/dim/dim_pricelist.sql")
    ...
    transformed_data = transform_data_pricelist(extracted_data_exapro)

    load_dataframe(connection=env_data_warehouse, schema="public", tablename="dim_pricelist_name", mode="append", df=extracted_data_exapro)
