...
from mutif_etl.transform.dim.dim_entities import transform_data_entities
...
if __name__ == '__main__':
    ...
    transformed_data = transform_data_entities(extracted_data_exapro)

    load_dataframe(connection=env_data_warehouse, schema="public", tablename="dim_entities", mode="append", df=transformed_data)
