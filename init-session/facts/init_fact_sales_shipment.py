...
from mutif_etl.transform.init.facts.fact_sales_shipment import transform_data_shipment
...
if __name__ == "__main__":
    ...
    file_query = Path(__file__).parent.parent.parent.joinpath(r"queries\facts\init_fact_sales_shipment.sql")
